 ...
 */
export async function navigatorStartTask(
  client: ExfuncCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StartTaskRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/navigator/start-task")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.StartTaskResponseBody$inboundSchema),
