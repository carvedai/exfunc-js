 ...
 */
export async function googleGetProduct(
  client: ExfuncCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetProductRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/google/get-product")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetProductResponseBody$inboundSchema),
