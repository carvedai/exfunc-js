 ...
 */
export function linkedinSearchCompanies(
  client: ExfuncCore,
  request: operations.SearchCompaniesRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SearchCompaniesResponseBody,
    | errors.UserError
    | errors.ServerError
    | ExfuncError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SearchCompaniesRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/linkedin/search-companies")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SearchCompaniesResponseBody$inboundSchema),
