 ...
 */
export async function navigatorGetTask(
  client: ExfuncCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetTaskRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/navigator/get-task")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetTaskResponseBody$inboundSchema),
