 ...
 */
export async function googleSearchProducts(
  client: ExfuncCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SearchProductsRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/google/search-products")();
