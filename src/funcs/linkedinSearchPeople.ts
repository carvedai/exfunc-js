 ...
 */
export function linkedinSearchPeople(
  client: ExfuncCore,
  request: operations.SearchPeopleRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SearchPeopleResponseBody,
    | errors.UserError
    | errors.ServerError
    | ExfuncError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SearchPeopleRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/linkedin/search-people")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SearchPeopleResponseBody$inboundSchema),
